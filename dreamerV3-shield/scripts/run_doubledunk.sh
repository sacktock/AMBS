...
python train.py --logdir ./logdir/doubledunk/shield --configs atari xlarge --task atari_double_dunk --env.atari.labels out-of-bounds shoot-bf-clear --run.steps 10000000
